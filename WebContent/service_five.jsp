...
<div id="tooplate_fp_100_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					...
					<li><a href="service_five" class="current">Untouchability </a></li>
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/images (5).jpg" width="250" height="175"></td>
          <%
...
%>
                <td> <form action="service_store5.jsp" enctype="multipart/form-data" method="post">
