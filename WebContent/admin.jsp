...
<div id="tooplate_fp_100_wrapper">
	<div id="tooplate_fp_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					<li><a href="index.html" >Home hz</a></li>
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/maps (1).jpg" width="180" height="125"></td>
          <td>
		   <form method="post" name="f" action="admin1.jsp">
						<div class="CSSTableGenerator">
						<table>
						<tr><td colspan="2" align="center">
                 <p align="center"><strong><font size="4">Admin Login</font></strong></p></td></tr>
                                   
                  <tr><td>Admin Name</td>
                  <td><input type="text" id="author" name="admin"/></td></tr>
