...
<div id="tooplate_fp_100_wrapper">
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/images.jpg" width="180" height="125"></td>
          <td>
		   <form method="post" name="f" action="general_login.jsp">
						<div class="CSSTableGenerator">
						<table>
                <tr><td colspan="2"> <p align="center">User Login</p></td></tr>
                                   
                  <tr><td>UserName</td>
                  <td><input type="text" id="author" name="uname"/></td></tr>
                  
                  
                  <tr><td>Password</td>
                  <td><input type="password" id="email" name="pass"/></td></tr>
                ...
                <center><a href="register.jsp"><font color="#FF0000" size="-1"> Register Here</font></a> </center>
