...
<div id="tooplate_fp_100_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					...
					<li><a href="service_one.jsp" >Child Labor</a></li>
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/image1o.jpg" width="250" height="150"></td>
          <td>
		      <%
		   ...
		   <table>
		    <p align="center"><font color="#990000" size="+2"><strong>Compliant Status</strong></font></p>
		   <tr bgcolor="#99CC66">
		   ...
		   try 
             {
            	 ...
            	 ps = con.prepareStatement("select * from compliant where name='"+username+"'");
