...
<div id="tooplate_fp_100_wrapper">
	<div id="tooplate_fp_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					...
					<li><a href="service_one.jsp" class="current">Child Labor</a></li>
        ...
        <tr> 
          <td><img  src="images/compl.jpg" width="250" height="200"></td>
          <%
...
%>
                <td> <form action="service_store.jsp" enctype="multipart/form-data" method="post">
               <div class="CSSTableGenerator">
				  ...
				  <tr><td colspan="2"> <h4><u><font color="#FF00FF">Your Details</font></u></h4></td></tr>
                   ...
                   <tr><td colspan="8"> <h4><u><font color="#FF00FF">Incident's Details</font></u></h4></td></tr>
                    <tr> 
					  ...
					  <tr><td>Incident District</td>
                        ...
                        <option value="Select">Select</option> <option value="Kanchipuram">Bangalore</option> 
                        <option value="Tiruvallur">Chitradurga</option> <option value="Cuddalore">Mysore</option> 
                        <option value="Villupuram">Vijayapura</option> <option value="Vellore">Tumakur</option> 
                        <option value="Tiruvannamalai">Gulbarga</option></select> 
                      </td></tr>
                    ...
                    <tr> 
                      <td>Vedio</td>
                      <td><input type="file" name="file" ></textarea> </td></tr>
	 ...
	 <%
String indt=request.getParameter("indistrict");
		session.setAttribute("district",indt);
%>
		</div> <!-- end of middle -->
