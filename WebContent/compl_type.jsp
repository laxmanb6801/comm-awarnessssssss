...
<div id="tooplate_fp_100_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					...
					<li><a href="compl_type.jsp" class="current">Category</a></li>
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/cap-logo.gif" width="200" height="150"></td>
          <td>
		 <form method="post" name="f" action="viewcompliant.jsp">
	
            <div class="CSSTableGenerator">
            	<table>
				<tr><td colspan="2"><p align="center">Compliant Type</p></td></tr>
            <tr> 
                      <td width="140" height="40">Category</td>
                      <td><select name="category" id="category"  />
                        <option value="Select">Select</option> <option value="Child Labor">Child Labor
						</option> <option value="child marriage">Child Marriage</option> 
                        <option value="Pollution Control">Pollution Control</option> 
                        <option value="Round spiral protection">Round spiral protection</option> 
                        <option value="Practice of untouchability">Practice of untouchability</option> </select></td>
                    </tr>
