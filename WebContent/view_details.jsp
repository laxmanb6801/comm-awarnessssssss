...
<div id="tooplate_fp_100_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					...
					<li><a href="view_details.jsp" class="current">Details</a></li>
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/maps (2).jpg" width="180" height="125"></td>
          <td>
		
		   <form method="post" name="f" action="admin1.jsp">
				  ...
				  <table>
						  ...
						  <p align="center"><font color="#9900FF" size="+2"><strong>View Compliant Status</strong></font></p>
                 <!--<p align="center">View Compliant Details</p></td></tr>-->
				 <tr bgcolor="#99CC66"> <td>Incident Place</td>
					<td>Type of compliant</td>
				  <td>Compliant</td>
				  <td>Status</td> </tr>
				    ...
				    try 
             {
            	 ...
            	 ps = con.prepareStatement("select * from compliant where indistrict='"+a+"'");
