...
<div id="tooplate_fp_100_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					...
					<li><a href="service_four" class="current">Drugs </a></li>
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/anti-drugs.jpg" width="225" height="180"></td>
          <%
...
%>
                <td> <form action="service_store4.jsp" enctype="multipart/form-data" method="post">
