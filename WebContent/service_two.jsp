...
<div id="tooplate_fp_100_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					...
					<li><a href="service_two" class="current">Child Marriage</a></li>
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/child marriage.jpg" width="250" height="175"></td>
          <%
...
%>
                <td> <form action="service_store1.jsp" enctype="multipart/form-data" method="post">
