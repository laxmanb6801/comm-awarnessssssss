...
<div id="tooplate_fp_100_wrapper">
		...
		<div id="tooplate_header">
			...
			<div id="tooplate_menu">
				<ul>
					...
					<li><a href="district.jsp" class="current">District</a></li>
    ...
    <!-- end of forever header -->
        ...
        <tr> 
          <td><img  src="images/maps (1).png" width="250" height="150"></td>
          <td>
		   <form method="post" name="f" action="view_details.jsp">
						<div class="CSSTableGenerator">
						<table>
               <tr><td colspan="2"><center>welcome :<%=admin %> </center></td></tr>
                  <tr>
				  <tr><td width="140" height="40">Select District</td>
				 
              <td><select name="district" id="district" style="width: 175px;"/>
              ...
              <option value="Tiruvannamalai">Tiruvannamalai</option></select></td>
				  </tr>
                  
                 
                    <tr><td></td><td align="center"><input type="submit" value="Login" id="submit" name="submit" onsubmit="return validation()" /></td></tr>
                   </table>
                  </form>
